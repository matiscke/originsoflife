...
\rev{
Appart from the caveat that the likelihood for $H_{1}$ cannot be expressed analytically due to being conditioned by n_{\lambda} (equation \ref{eq:semian:likelihoodH1}), computing posterior probabilities is challenging due to the unknown priors.
}

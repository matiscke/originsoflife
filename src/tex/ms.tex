...
\rev{
\subsubsection{Bayesian Evidence and the Influence of Priors}\label{sec:discussion-bayes}}
Our semi-analytical analysis (Section~\ref{sec:results-semianalytical}) employs Bayes factors to quantify the evidence in favor of or against the UV~Threshold Hypothesis that future observations may provide.

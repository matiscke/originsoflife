...
\begin{abstract}
The origin of life on Earth may provide testable hypotheses about biosignature distributions in exoplanet populations.
Motivated by the cyanosulfidic origins-of-life scenario, we investigate the hypothesis that a minimum near-ultraviolet (NUV) flux is necessary for abiogenesis.
Using a semi-analytical Bayesian framework and the Bioverse survey simulator, we estimate the probability of obtaining strong evidence for or against this UV Threshold Hypothesis with potential future biosignature surveys.
...
\begin{figure}
    ...
    \begin{centering}
        ...
        \caption{Fraction of inhabited planets for different threshold \gls{NUV} fluxes under the UV~Threshold Hypothesis if the abiogenesis rate is 1.
...
We note that relevant mission concepts, such as the Large Interferometer for Exoplanets~\citep[\life,][]{Quanz2022}, include M-dwarf systems among their primary targets~\citep{Kammerer2018,Carrion-Gonzalez2023}.

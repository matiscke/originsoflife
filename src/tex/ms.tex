...
For a fixed planet sample size, the fraction of inhabited planets is highest in the M~dwarf sample due to the higher \gls{NUV} fluxes in the \gls{HZ} of these stars (see Figure~\ref{fig:surveys_FGKM}).
...
%Because of that, most inhabited planets in our magnitude- and volume-limited sample orbit M~dwarfs.

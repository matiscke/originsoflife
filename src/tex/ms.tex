...
\rev{
We nominally adopt $\Delta T_\mathrm{min} = \SI{1}{\mega\year}$.
Under $H_1$, longer origins timescales have minimal impact on a generic transit survey but significantly decrease the fraction of inhabited planets around FGK stars, as explored in Appendix~\ref{sec:long-origins}.
}

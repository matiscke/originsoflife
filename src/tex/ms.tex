...
\begin{align}
    \frac{\pdf(H_1|bio)}{\pdf(H_2|bio)} = \frac{\pdf_\mathrm{\eta, 1} \pdf_\mathrm{det, 1}}{\pdf_\mathrm{\eta, 2} \pdf_\mathrm{det, 2}},
\end{align}
...
In the following, we discuss the impact of the remaining variables $\pdf_\mathrm{\eta, i}$ and $\pdf_\mathrm{det, i}$ on the Bayes factor.

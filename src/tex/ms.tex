...
\begin{figure*}
    ...
    \begin{centering}
        ...
        Bottom: Recovered biosignature detections ($\checkmark$) and non-detections ($\oslash$) of simulated transit surveys. The dashed line denotes $F_\mathrm{NUV, min}$.}
...
\begin{figure}
    ...
    \begin{centering}
        ...
        \caption{Fraction of inhabited planets for different threshold \gls{NUV} fluxes under the UV~Threshold Hypothesis if the abiogenesis rate is \var{f_life}. Shaded regions denote 90 percent confidence intervals of randomized sample generations, and dashed lines correspond to samples including non-transiting planets.
    ...
    \end{centering}
\end{figure}
Figure \ref{fig:inhabited_aafo_nuv_thresh} shows the fraction of inhabited planets under the UV~Threshold Hypothesis for different threshold \gls{NUV} fluxes and for a high abiogenesis rate of \var{f_life}.

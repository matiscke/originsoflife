...
\rev{If the rate of life’s emergence and persistence $f_\mathrm{life}$ is at a \SI{1}{\percent} level or lower, no currently planned exoplanet mission concept has projected sample sizes sufficient to test the UV~Threshold Hypothesis.
One } exception is the Nautilus Space Observatory concept~\citep{Apai2019,Apai2022}.

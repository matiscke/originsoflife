...
... measure the maximum past \gls{NUV} flux with a precision of \var{nautilus_max_nuv} and the instellation that a planet receives with a precision of \var{nautilus_S}.
...
\begin{figure}
    ...
    \begin{centering}
        ...
        \caption{Fraction of inhabited planets for different threshold \gls{NUV} fluxes under the UV hypothesis if the abiogenesis rate is \var{f_life}.}

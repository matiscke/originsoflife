...
In these units, the above threshold is approximately \var{rimmer_threshold}$\pm$\var{rimmer_uncertainty}$\,$\SI{}{\erg\per\second\per\centi\meter\squared}.
However, due to uncertainties in how surface flux relates to top-of-atmosphere flux in the habitable zone, we treat the threshold \gls{NUV} flux as a free parameter.}

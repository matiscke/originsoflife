...
\begin{figure}
    ...
    \begin{centering}
        ...
        \caption{Host stars of all transiting \glspl{EEC} and inhabited planets.
...
\begin{figure*}
    ...
    \begin{centering}
        ...
        A few example tracks are shown, where extended overlap of \gls{HZ} occupancy and high \gls{NUV} flux (green sections) fulfill our requirement for abiogenesis.
